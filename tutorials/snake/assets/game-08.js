...
(function (window, document, undefined) {
  ...
  function actions() {
    ...
    if (!pause) {
      ...
      if (snake[0].intersects(food)) {
        ...
        snake.push(new ImageRectangle(0, 0, '#00ff00', sectImg, 10));
  ...
  function reset() {
    ...
    snake.length = 0;
    snake.push(new ImageRectangle(300, 150, '#00ff00', sectImg, 10));
    snake.push(new ImageRectangle(290, 150, '#00ff00', sectImg, 10));
    snake.push(new ImageRectangle(280, 150, '#00ff00', sectImg, 10));
  ...
  function init() {
    ...
    // Create initial food
    food = new ImageRectangle(450, 280, '#ff0000', foodImg, 10);
